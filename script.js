...
/* ============================================================
   AN PROGRESS — SUPABASE SYNC HOOK
   Ditambahkan di bagian bawah script.js
   Tidak mengubah apapun di atas
   ============================================================ */

/* Simpan referensi simpanData asli */
const _simpanDataOriginal = simpanData;

/* Override simpanData — otomatis trigger cloud sync setelah save lokal */
function simpanData() {
  _simpanDataOriginal();
  /* Trigger cloud sync kalau user sudah login */
  if (window.ANSupabase && window.ANSupabase.getCurrentUser()) {
    window.ANSupabase.syncData();
  }
}
